...
COLORS = {
    'ARDQN-FTA-GridworldPartial':     '#ffd92f',  # yellow
    'ARDQN-ReLU-GridworldPartial':    '#a6d854',  # green
    'ARDRQN-FTA-GridworldPartial':    '#fc8d62',  # orange
    'ARDRQN-ReLU-GridworldPartial':   '#66c2a5',  # teal
    'DRQN-FTA-Gridworld':           '#fc8d62',  # orange
    'DRQN-ReLU-Gridworld':          '#66c2a5'  # teal
}
...
if __name__ == "__main__":
    ...
    for env, sub_results in results.groupby_directory(level=4):
        ...
        for alg_result in sub_results:
            ...
            ys = np.array([np.mean(ar, axis=1) for ar in np.split(np.asarray(ys), 1000, axis=1)]).T
