...
# Define the algorithms with associated colors using a dictionary
algorithms = {
    'DRQN-ReLU-Gridworld': 'red',
    'DRQNAux-ReLU-Gridworld': 'green',
    'DRQN-FTA-Gridworld': 'blue',
    'DRQNAux-FTA-Gridworld': 'yellow'
}

# Define new labels for algorithms
new_labels = {'DRQN-ReLU-Gridworld': 'ReLU', 'DRQNAux-ReLU-Gridworld': 'ReLU (VF5)', 'DRQN-FTA-Gridworld': 'FTA', 'DRQNAux-FTA-Gridworld': 'FTA (VF5)'}

# Compute mean values and bootstrap confidence intervals for each metric and algorithm
data_mean = {}
data_err_lower = {}
data_err_upper = {}
...
for alg, color in algorithms.items():
    ...
    for metric in metrics:
         ...
         # Differences from the mean to the lower and upper CI bounds
