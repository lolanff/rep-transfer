...
config = {
    'ReLU': {
        'algorithm': {
            'DQN-ReLU-GridworldPartial': 'red',
            'DRQN-ReLU-GridworldPartial': 'blue',
        },
        'new_labels': {
            'DQN-ReLU-GridworldPartial': 'FF ReLU', 
            'DRQN-ReLU-GridworldPartial': 'RNN ReLU', 
        }
    },
    'FTA': {
        'algorithm': {
            'DQN-FTA-GridworldPartial': 'red',
            'DRQN-FTA-GridworldPartial': 'blue',
            # 'DRQNAux-FTA-Gridworld': 'yellow'
        },
        'new_labels': { 
            'DQN-FTA-GridworldPartial': 'FF FTA',
            'DRQN-FTA-GridworldPartial': 'RNN FTA',
...
for name, info in config.items():
    ...
    fig.suptitle(f"Representation Properties {name} GridworldPartial", fontsize=28, fontweight='bold')
