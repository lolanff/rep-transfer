...
python scripts/local.py --runs 25 -e experiments/Gridworld/train/DQN-ReLU-A.json --cpus 25
python scripts/local.py --runs 25 -e experiments/Gridworld/train/DQN-ReLU-B.json --cpus 25
